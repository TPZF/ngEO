...
var BrowsesLayer = function (params, mapEngine) {
	 ...
	 */
	this.addBrowse = function (feature, browseUrl, browseCrossOrigin) {
		...
		if (!browseLayersMap.hasOwnProperty(browseId)) {
			...
			_.merge(layerDesc, {
				...
				bbox: feature.bbox,
				crossOrigin: browseCrossOrigin ? browseCrossOrigin : Configuration.get("map.browseDisplay.crossOrigin", "anonymous")
			});
